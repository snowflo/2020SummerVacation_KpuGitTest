...
//gps 메시지 안나옴. gps 누르면 현위치 도착함.
//출처: https://m.blog.naver.com/PostView.nhn?blogId=oper4062&logNo=221454681852&proxyReferer=https:%2F%2Fwww.google.com%2F
class MapTest : AppCompatActivity(), OnMapReadyCallback {
    ...
    lateinit var locationCallback: MyLocationCallBack // 내부 클래u스, 위치 변경 후 지도에 표시.

    val polyLineOptions = PolylineOptions().width(5f).color(Color.RED)
    //경로를 표시할 펜 구성.
    // 다각으로 꺽어지는 선, 굵기는 5f, 색상은 빨강.

    val REQUEST_ACCESS_FINE_LOCATION = 1000 // 좀 더 정확하게!!하기
